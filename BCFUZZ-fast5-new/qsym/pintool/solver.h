...
namespace qsym
{
  ...
  public:
    ...
    bool checkAndSave(const std::string &postfix = "", const std::string &taken = "");
    void addJcc(ExprRef, bool, ADDRINT, ADDRINT);
  ...
  protected:
    ...
    void saveValues(const std::string &postfix, const std::string &taken);
    ...
    bool isInterestingJcc(ExprRef, bool, ADDRINT, ADDRINT, ADDRINT &, ADDRINT &);
    void negatePath(ExprRef, bool, ADDRINT, ADDRINT &, ADDRINT &);
